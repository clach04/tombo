...
However it relies on some third-party libraries and the source code is NOT in this repo, but 32-bit pre-built lib and DLLs are included in the source code repo 😢
